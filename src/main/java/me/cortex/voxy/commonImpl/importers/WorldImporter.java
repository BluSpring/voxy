...
public class WorldImporter implements IDataImporter {
    ...
    public WorldImporter(WorldEngine worldEngine, Level mcWorld, ServiceManager sm, BooleanSupplier runChecker) {
        ...
        this.biomeCodec = ChunkSerializer.makeBiomeCodec(mcWorld.registryAccess().registryOrThrow(Registries.BIOME));
        this.blockStateCodec = ChunkSerializer.BLOCK_STATE_CODEC;
    }
